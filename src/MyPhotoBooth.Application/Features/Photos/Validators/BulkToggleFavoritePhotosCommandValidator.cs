...
public class BulkToggleFavoritePhotosCommandValidator : AbstractValidator<BulkToggleFavoritePhotosCommand>
{
    public BulkToggleFavoritePhotosCommandValidator()
    {
