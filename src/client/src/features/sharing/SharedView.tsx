...
export function SharedView() {
  ...
  return (
   <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-purple-50/10 flex items-center justify-center">
    <div className="text-center">
     <div className="w-24 h-24 mx-auto mb-6 rounded-3xl bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center shadow-lg">
     ...
     <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-2">Link not found</h2>
     <p className="text-gray-600 text-lg">This share link doesn't exist or has been removed.</p>
    </div>
   </div>
  )
 }
  ...
  return (
   <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-purple-50/10 flex items-center justify-center">
    <div className="text-center">
     ...
     <p className="text-gray-600 text-lg">This share link is no longer active.</p>
    </div>
   </div>
  )
 }
 ...
 if (meta.hasPassword && !content) {
  return (
   <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-purple-50/10 flex items-center justify-center relative overflow-hidden">
    ...
    <div className="relative glass-strong rounded-3xl p-10 w-full max-w-sm mx-4 shadow-2xl animate-fade-in-up">
     <div className="text-center mb-8">
      <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-primary-500 to-purple-600 flex items-center justify-center shadow-xl float">
      ...
      <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-2">Password Protected</h2>
      <p className="text-sm text-gray-600">Enter the password to view this content.</p>
     </div>
     ...
     <form onSubmit={handlePasswordSubmit} className="space-y-4">
      ...
      {passwordError && (
       <div className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-red-700 bg-red-50/90 backdrop-blur-sm rounded-lg border border-red-200">
      ...
      <button
       ...
       className="w-full btn-primary-lg py-4 shadow-xl"
      >
 ...
 return (
  <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-purple-50/10">
   {/* Header */}
   <header className="glass-strong border-b border-gray-200/50 px-6 py-4 sticky top-0 z-30">
    <div className="max-w-6xl mx-auto flex items-center gap-3">
     ...
     <span className="font-semibold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent text-lg">MyPhotoBooth</span>
   ...
   <main className="max-w-[1800px] mx-auto p-6">
    {content.type === 'Album' && content.album && (
     <div className="mb-8">
      <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-2">{content.album.name}</h1>
      {content.album.description && (
       <p className="text-gray-600 text-lg">{content.album.description}</p>
      )}
