...
export default function ShareManagement() {
 ...
 return (
  <div className="p-6 max-w-[1800px] mx-auto">
   <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-8">Shared Links</h1>
   ...
   {(!links || links.length === 0) && (
    <div className="flex flex-col items-center justify-center py-32 text-gray-600">
     ...
     <h3 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-3">No shared links yet</h3>
     <p className="text-gray-600 text-lg">Share photos or albums from the gallery to create links</p>
    </div>
   )}
